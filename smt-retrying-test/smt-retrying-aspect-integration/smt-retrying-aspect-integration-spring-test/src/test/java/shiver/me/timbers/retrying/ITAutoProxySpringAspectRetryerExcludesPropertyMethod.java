...
public class ITAutoProxySpringAspectRetryerExcludesPropertyMethod extends AbstractITSpringAspectRetryerExcludesPropertyMethod {

    @Autowired
    private AutoProxyRetryerDefaultsMethodFactory defaultsFactory;

    @Autowired
    private AutoProxyRetryerExcludesMethodFactory includesFactory;

    @Autowired
    private AutoProxyRetryerExcludesWithIncludesMethodFactory includesWithExcludesFactory;
