...
public class RetryerIncludesMethodFactory extends RetryerIncludesFactory {

    public RetryerIncludesMethodFactory() {
        this(new RetryerIncludesMethod(), new RetryerNoIncludesMethod(), new RetryerAddIncludeMethod());
    }
