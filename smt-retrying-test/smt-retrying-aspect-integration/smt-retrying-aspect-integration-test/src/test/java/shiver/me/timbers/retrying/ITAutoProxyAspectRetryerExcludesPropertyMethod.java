...
public class ITAutoProxyAspectRetryerExcludesPropertyMethod extends AbstractITAspectRetryerExcludesPropertyMethod {
    ...
    @Autowired
    private AutoProxyRetryerExcludesWithIncludesMethodFactory excludesWithExcludesFactory;
    ...
    public AutoProxyRetryerExcludesWithIncludesMethodFactory excludesWithIncludesFactory() {
        return excludesWithExcludesFactory;
    }
}
