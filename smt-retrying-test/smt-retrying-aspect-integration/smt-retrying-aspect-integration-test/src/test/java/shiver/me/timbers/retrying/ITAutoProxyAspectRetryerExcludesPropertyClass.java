...
public class ITAutoProxyAspectRetryerExcludesPropertyClass extends AbstractITAspectRetryerExcludesPropertyClass {
    ...
    @Autowired
    private AutoProxyRetryerExcludesWithIncludesClassFactory excludesWithExcludesFactory;
