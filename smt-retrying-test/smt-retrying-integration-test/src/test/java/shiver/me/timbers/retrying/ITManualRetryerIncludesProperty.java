...
public class ITManualRetryerIncludesProperty extends AbstractITRetryerIncludeProperty {
    ...
    @Override
    protected RetryerInclude addInclude(int retries, Throwable include) {
        return new ManualRetryerInclude<>(retries, include);
    }
}
