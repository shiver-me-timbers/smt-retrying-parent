...
import shiver.me.timbers.retrying.execution.SpringManualRetyerRetries;
...
public class ITManualSpringRetryerRetriesProperty extends AbstractITSpringRetryerRetriesProperty {
    ...
    @Override
    protected RetyerRetries overrideRetries(int retries) {
        return new SpringManualRetyerRetries(retries);
    }
}
