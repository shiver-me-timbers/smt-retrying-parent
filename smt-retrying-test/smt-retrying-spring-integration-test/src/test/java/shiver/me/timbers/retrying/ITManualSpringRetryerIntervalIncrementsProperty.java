...
public class ITManualSpringRetryerIntervalIncrementsProperty extends AbstractITSpringRetryerIntervalIncrementsProperty {
    ...
    @Override
    RetryerIntervalIncrements overrideIntervalIncrements(int retries, TimeUnit unit, Long... durations) {
